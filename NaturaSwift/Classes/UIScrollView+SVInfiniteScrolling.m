...
- (void)setScrollViewContentInsetForInfiniteScrolling {
    UIEdgeInsets currentInsets = self.scrollView.contentInset;
    if (_isRemoveScrollingViewHeight) {
        currentInsets.bottom = self.originalBottomInset;
...
-(void)setIsRemoveScrollingViewHeight:(BOOL)isRemoveScrollingViewHeight
{
    _isRemoveScrollingViewHeight = isRemoveScrollingViewHeight;
